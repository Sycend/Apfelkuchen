 ...
 *
 * @see Return Value in R = MinMaxListe =>
 *      runAndReturnResultOnline("MinMaxListe"); MinMax returned: MinMaxListe =>
 *      Liste aus x_low[DoubleArray], colnames(x_low)[StringArray],
